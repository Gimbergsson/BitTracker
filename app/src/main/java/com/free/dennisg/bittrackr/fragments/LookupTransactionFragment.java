...
public class LookupTransactionFragment extends Fragment {

    public static LookupTransactionFragment newInstance(int index) {
        LookupTransactionFragment fragment = new LookupTransactionFragment();
